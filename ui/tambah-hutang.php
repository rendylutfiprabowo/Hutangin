<?php
    ...
    if(isset($_POST["submit"]))
    {
        ...
        mysqli_query($conn,"INSERT INTO `hutang`(`id`, `id_user`, `nama_penghutang`, `nama_hutang`, `tanggal_pinjam`, `jatuh_tempo`, `jumlah`, `sisa_hutang`) VALUES ('', '$userId', '$penghutang','$namaHutang','$tanggalPinjam','$jatuhTempo','$jumlah','$jumlah')");
        echo '<script>alert("Berhasil menambahkan data hutang!")
...
<head>
    ...
    <title>Tambah Data Hutang - Hutangin</title>
...
<body>
    ...
    <section class="section-content container">
        <h1 class="text-center mt-3 mb-3">Tambah Data Hutang</h1>
                ...
                <form action="" method="post">
                    ...
                    <div class="my-3">
                        ...
                        <input type="date" class="form-control form-control-lg" id="tanggalPinjam" name="tanggalPinjam"
                            value="<?php echo "20".$date; ?>" required>
                    </div>
                    <div class="my-3">
